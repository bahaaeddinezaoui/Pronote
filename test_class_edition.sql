...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 15, 2025 at 01:02 PM
...
(1, 2, 'Yacine', 'ROUABHIA', 'Lieutenant-colonel', 'Chef Brigade');
...
('1', 7, 1, 'Yazid', 'BELFRAG', 'EOA'),
('2', 7, 1, 'Mohamed Wassim', 'OUHAB', 'EOA'),
('3', 7, 2, 'Brahim Abderezak', 'BOUDRA', 'EOA');
...
('2', 3, 'Lieutenant', 'Bahaa Eddine', 'ZAOUI');
...
(1, 'teacher1', '$2y$10$FPgoRYiqkoXZVi9PefLek.iByOCxECtzCisUJoih0Hr6PFGElfSjW', 'merinemohamed@esam.com', 'Teacher', 'Active', NULL, NULL),
(2, 'admin1', '$2y$10$A5zmNOHnXmMxVeD4.fJHPu0Ww64OKkxm0UdxTD7bWzi3wYNKkOwye', 'admin1@esam.com', 'Admin', 'Active', NULL, NULL),
(3, 'teacher2', '$2y$10$w50.DE1y2mi4n4AdBoip5eVoOuJpw5FHkMN0VN17947w4fGsDNRIy', 'zaouibahaaeddine@esam.com', 'Teacher', 'Active', NULL, NULL);
COMMIT;
